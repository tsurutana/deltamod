...
import deltamod.geom.Regularization;

public class OpsPanelRegularize extends AbstractOpsPanel {
	...
	public void perform() {
		...
		Regularization optv = new Regularization(DeltaMod.doc.getModel(), 1.0e-12);
